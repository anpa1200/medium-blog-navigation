...
const config = {
  ...
  baseUrl,
  scripts: [
    {src: 'https://1200km.com/assets/theme-bootstrap.js'},
    {src: 'https://1200km.com/assets/docusaurus-ecosystem.js?v=20260614-3', defer: true},
    {src: 'https://1200km.com/assets/site-theme.js?v=20260721-shell', defer: true},
  ],
