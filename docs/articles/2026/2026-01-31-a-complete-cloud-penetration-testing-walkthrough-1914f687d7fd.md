...
description: "How I Discovered Critical Vulnerabilities in a Cloud Environment Using Basic Tools and Methodical Testing"
image: "https://cdn-images-1.medium.com/max/800/1*uc4qewXjjEC8q9Q6Ag_j8A.png"
---
...
- **Category:** CTI
- **Source article:** [https://medium.com/@1200km/a-complete-cloud-penetration-testing-walkthrough-1914f687d7fd](https://medium.com/@1200km/a-complete-cloud-penetration-testing-walkthrough-1914f687d7fd)
...
[Learn how SQLMap transforms the landscape of database security by automating the detection and exploitation of SQL…](../2024/2024-11-04-sqlmap-a-deep-dive-into-automated-sql-injection-testing-part-1-basic-wizard-6dd540363c83.md)
...
- Start Burp Suite and configure the proxy to listen on`127.0.0.1:8080`
...
- **Suspicious endpoints:**Parameters like`?cmd=`and`?url=`immediately raised red flags
