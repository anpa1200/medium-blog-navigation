...
- **Category:** CTI
- **Source article:** [https://infosecwriteups.com/operation-desert-hydra-ai-assisted-cti-pipeline-muddywater-to-kibana-34da7917acf0](https://infosecwriteups.com/operation-desert-hydra-ai-assisted-cti-pipeline-muddywater-to-kibana-34da7917acf0)
- **Published:** 2026-05-23
- **Preserved media:** 32 image(s), including cover images, screenshots, diagrams, and infographics where present.
- **Preserved technical blocks:** 40 code/configuration block(s).
:::
...
Everything is on my GitHub:[github.com/anpa1200/operation-desert-hydra](https://github.com/anpa1200/operation-desert-hydra)

[GitHub - anpa1200/operation-desert-hydra: OpenCTI-based CTI-to-Detection Knowledge Graph for Iranian activity against Israeli organizations](https://github.com/anpa1200/operation-desert-hydra)

1. **Why MuddyWater?**
2. **The Pipeline**
3. **Phase 1: Source Gathering**
4. **Phase 2: Procedure Dataset**
5. **Phase 3: OpenCTI Knowledge Graph**
6. **Phase 4: Detection Atlas**
7. **Phase 5: Validation Lab**
8. **Validation Results Summary**
9. **Phase 6: Coverage Matrix**
10. **What Defenders Should Do Right Now**
...
1. [Israel National Cyber Directorate — MuddyWater page](https://www.gov.il/en/pages/_muddywater)
2. [Israel National Cyber Directorate — MuddyWater / DarkBit PDF](https://www.gov.il/BlobFolder/news/_muddywater/en/government%20threat%20actor.pdf)
3. [Israel National Cyber Directorate — Technological Advancement and Evolution of MuddyWater in 2024 PDF](https://www.gov.il/BlobFolder/reports/maddy_water_2024/en/ALERT_CERT_IL_W_1858.pdf)
4. [Israel National Cyber Directorate — Overview of Recent Phishing PDF](https://www.gov.il/BlobFolder/reports/alert_1947/he/ALERT-CERT-IL-W-1947.pdf)
5. [ClearSky — Operation Quicksand: MuddyWater’s Offensive Attack Against Israeli Organizations](https://www.clearskysec.com/operation-quicksand/)
6. [ClearSky — Operation Quicksand PDF](https://www.clearskysec.com/wp-content/uploads/2020/10/Operation-Quicksand.pdf)
...
8. [Microsoft — Exposing POLONIUM activity and infrastructure targeting Israeli organizations](https://www.microsoft.com/en-us/security/blog/2022/06/02/exposing-polonium-activity-and-infrastructure-targeting-israeli-organizations/)
9. [Proofpoint — TA450 Uses Embedded Links in PDF Attachments in Latest Campaign](https://www.proofpoint.com/us/blog/threat-insight/security-brief-ta450-uses-embedded-links-pdf-attachments-latest-campaign)
10. [HarfangLab — MuddyWater campaign abusing Atera Agents](https://harfanglab.io/insidethelab/muddywater-rmm-campaign/)
11. [Deep Instinct — DarkBeatC2: The Latest MuddyWater Attack Framework](https://www.deepinstinct.com/blog/darkbeatc2-the-latest-muddywater-attack-framework)
12. [SC Media — Novel C2 tool leveraged in latest MuddyWater attacks](https://www.scworld.com/brief/novel-c2-tool-leveraged-in-latest-muddywater-attacks)
13. [Check Point — MuddyWater Threat Group Deploys New BugSleep Backdoor](https://blog.checkpoint.com/research/muddywater-threat-group-deploys-new-bugsleep-backdoor/)
14. [ESET / WeLiveSecurity — MuddyWater: Snakes by the riverbank](https://www.welivesecurity.com/en/eset-research/muddywater-snakes-riverbank/)
15. [ESET press release — Iran’s MuddyWater targets critical infrastructure in Israel and Egypt](https://www.eset.com/uk/about/newsroom/press-releases/iran-muddywater-critical-infrastructure-israel-egypt-snake-game-eset-research-uk/)
16. [Security Affairs — MuddyWater strikes Israel with advanced MuddyViper malware](https://securityaffairs.com/185244/apt/muddywater-strikes-israel-with-advanced-muddyviper-malware.html)
17. [The Hacker News — Iran-Linked MuddyWater Deploys Atera for Surveillance in Phishing Attacks](https://thehackernews.com/2024/03/iran-linked-muddywater-deploys-atera.html)

**Recent / Evolving MuddyWater Activity**

1. [Proofpoint — Around the World in 90 Days: State-Sponsored Actors Try ClickFix](https://www.proofpoint.com/us/blog/threat-insight/around-world-90-days-state-sponsored-actors-try-clickfix)
2. [Proofpoint — Crossed Wires: a case study of Iranian espionage and attribution](https://www.proofpoint.com/us/blog/threat-insight/crossed-wires-case-study-iranian-espionage-and-attribution)
3. [Group-IB — Operation Olalampo: Inside MuddyWater’s Latest Campaign](https://www.group-ib.com/blog/muddywater-operation-olalampo/)
4. [The Hacker News — MuddyWater Targets MENA Organizations with GhostFetch, CHAR, and HTTP_VIP](https://thehackernews.com/2026/02/muddywater-targets-mena-organizations.html)
5. [Rapid7 — Muddying the Tracks: The State-Sponsored Shadow Behind Chaos Ransomware](https://www.rapid7.com/blog/post/tr-muddying-tracks-state-sponsored-shadow-behind-chaos-ransomware/)
6. [The Hacker News — MuddyWater Uses Microsoft Teams to Steal Credentials in False Flag Ransomware Attack](https://thehackernews.com/2026/05/muddywater-uses-microsoft-teams-to.html)
7. [Rapid7 — Iran Conflict Cyber Threat Intelligence](https://www.rapid7.com/research/iran-conflict-cyber-threats/)
8. [ExtraHop — The Digital Front of Iranian Cyber Offensive and Defensive Response](https://www.extrahop.com/blog/the-digital-front-of-iranian-cyber-offensive-and-defensive-response)
9. [Abnormal Security — Tracking Iran-Aligned Cyber Operations Following U.S.-Israel Strikes](https://abnormal.ai/blog/iran-aligned-cyber-operations-email-threats)
10. [Unit 42 — Boggy Serpens Threat Assessment](https://unit42.paloaltonetworks.com/boggy-serpens-threat-assessment/)
11. [Hive Pro — MuddyWater: Iran’s Adaptive Cyber Espionage Machine](https://hivepro.com/threat-advisory/muddywater-irans-adaptive-cyber-espionage-machine/)
12. [Hive Pro — MuddyWater / Operation Olalampo PDF](https://hivepro.com/wp-content/uploads/2026/03/TA2026082.pdf)
13. [Kaspersky ICS CERT — APT and financial attacks on industrial organizations in Q2 2024 PDF](https://ics-cert.kaspersky.com/wp-content/uploads/2024/10/kaspersky-ics-cert-apt-and-financial-attacks-on-industrial-organizations-in-q2-2024-en.pdf)
14. [Kaspersky ICS CERT — APT and financial attacks on industrial organizations in Q2 2025 PDF](https://ics-cert.kaspersky.com/wp-content/uploads/2025/09/kaspersky-ics-cert-apt-and-financial-attacks-on-industrial-organizations-in-q2-2025-en-2.pdf)
15. [Trend Micro — Annual APT Report 2025 PDF](https://documents.trendmicro.com/assets/pdf/Annual_APT_Report_2025.pdf)
16. [Intel 471 — HUNTER Iranian Threat Actor Coverage PDF](https://go.intel471.com/hubfs/Emerging%20Threats/2025%20Emerging%20Threats/Upd%20HUNTER%20-%20Iranian%20Threat%20Actor%20Coverage.pdf)

**Iran Threat Context and Comparison Actors**

1. [CISA — Iran Threat Overview and Advisories](https://www.cisa.gov/topics/cyber-threats-and-advisories/advanced-persistent-threats/iran)
2. [CISA — Iran state-sponsored cyber threat publications](https://www.cisa.gov/topics/cyber-threats-and-advisories/nation-state-cyber-actors/iran/publications)
3. [CISA — AA23–335A: IRGC-Affiliated Cyber Actors Exploit PLCs in Multiple Sectors](https://www.cisa.gov/news-events/cybersecurity-advisories/aa23-335a)
4. [CISA — AA23–335A PDF](https://www.cisa.gov/sites/default/files/2023-12/aa23-335a-irgc-affiliated-cyber-actors-exploit-plcs-in-multiple-sectors-1.pdf)
5. [MITRE ATT&CK — APT34](https://attack.mitre.org/groups/G0049/)
6. [MITRE ATT&CK — APT35 / Charming Kitten](https://attack.mitre.org/groups/G0059/)
7. [MITRE ATT&CK — Agrius](https://attack.mitre.org/groups/G1030/)
8. [Microsoft — Mint Sandstorm](https://www.microsoft.com/en-us/security/security-insider/mint-sandstorm)
9. [Microsoft — Peach Sandstorm deploys new custom Tickler malware](https://www.microsoft.com/en-us/security/blog/2024/08/28/peach-sandstorm-deploys-new-custom-tickler-malware-in-long-running-intelligence-gathering-operations/)
10. [Microsoft Learn — How Microsoft names threat actors](https://learn.microsoft.com/en-us/microsoft-365/security/defender/microsoft-threat-actor-naming?view=o365-worldwide)
11. [SentinelOne — Iranian Cyber Activity Outlook](https://www.sentinelone.com/blog/sentinelone-intelligence-brief-iranian-cyber-activity-outlook/)
12. [Trellix — The Iranian Cyber Capability PDF](https://mirror.gpmidi.net/vx-underground/Malware%20Analysis/2024/2024-09-19%20-%20The%20Iranian%20Cyber%20Capability/Paper/2024-09-19%20-%20The%20Iranian%20Cyber%20Capability.pdf)

**OpenCTI / STIX / Knowledge Graph References**

1. [OpenCTI documentation — Data model](https://docs.opencti.io/latest/usage/data-model/)
2. [OpenCTI documentation — GraphQL API](https://docs.opencti.io/latest/reference/api/)
3. [OpenCTI documentation — Deduplication](https://docs.opencti.io/latest/usage/deduplication/)
4. [OASIS — STIX 2.1 HTML specification](https://docs.oasis-open.org/cti/stix/v2.1/stix-v2.1.html)
5. [OASIS — STIX 2.1 PDF specification](https://docs.oasis-open.org/cti/stix/v2.1/cs02/stix-v2.1-cs02.pdf)
6. [STIX Project — Relationships](https://stixproject.github.io/documentation/concepts/relationships/)
7. [STIXnet — Extracting STIX Objects in CTI Reports](https://arxiv.org/abs/2303.09999)
8. [From Text to Actionable Intelligence: Automating STIX Entity and Relationship Extraction](https://arxiv.org/abs/2507.16576)
9. [Context-aware Entity-Relation Extraction for Threat Intelligence Knowledge Graphs](https://arxiv.org/abs/2605.15904)

**Validate Before Promoting**

1. [Brandefense — MuddyWater PDF](https://brandefense.io/wp-content/uploads/2025/10/brandefense.io-muddywater-iran-linked-espionage-group-expanding-global-reach-muddywater-.pdf)
2. [KPMG — CTI Report MuddyWater PDF](https://assets.kpmg.com/content/dam/kpmgsites/in/pdf/2022/07/KPMG_CTI_Report_muddy.pdf.coredownload.inline.pdf)
...
**proc_mw_0001 — Spearphishing Email Delivery***Confidence: Observed · Sources: AA22–055A, INCD 2023, INCD 2024 · ATT&CK: T1566.001, T1566.002, T1534*
...
**proc_mw_0002 — Public-Facing Exploitation***Confidence: Observed · Sources: AA22–055A, INCD 2023, INCD 2024 · ATT&CK: T1190*
...
**proc_mw_0003 — PowerShell Execution and Script Obfuscation***Confidence: Observed · Sources: AA22–055A, INCD 2024 · ATT&CK: T1059.001, T1027*
...
**proc_mw_0004 — DLL Side-Loading***Confidence: Observed · Sources: AA22–055A, INCD 2024 · ATT&CK: T1574.002*
...
**proc_mw_0005 — Registry Run Key and Startup Folder Persistence***Confidence: Observed · Sources: AA22–055A, INCD 2024 · ATT&CK: T1547.001*
...
**proc_mw_0006 — Scheduled Task (43-Minute Beacon)***Confidence: Observed · Source: INCD 2024 (single source) · ATT&CK: T1053.005*
...
**proc_mw_0007 — RMM Tool Abuse***Confidence: Observed · Sources: AA22–055A, INCD 2023, INCD 2024, multiple vendor sources · ATT&CK: T1219*
...
**proc_mw_0008 — C2 via Web Protocols and DNS Tunneling***Confidence: Observed · Sources: AA22–055A, INCD 2024 · ATT&CK: T1071.001, T1572, T1102*
...
**proc_mw_0009 — WMI System Discovery Survey***Confidence: Observed · Source: AA22–055A (script documented verbatim) · ATT&CK: T1047, T1082, T1016, T1033, T1518.001*
...
**proc_mw_0010 — Credential Dumping from LSASS and Credential Stores***Confidence: Observed · Source: AA22–055A · ATT&CK: T1003.001, T1003.004, T1003.005*
...
[GitHub - anpa1200/opencti-intelligent-shield: OpenCTI AI-driven threat intelligence enrichment with Claude and Docusaurus documentation](https://github.com/anpa1200/opencti-intelligent-shield)

- **Medium guide:**

[The Intelligent Shield. OpenCTI](https://medium.com/@1200km/the-intelligent-shield-057c9b4b9394)

- **Main guide:**<a href="https://1200km.com/opencti-intelligent-shield/" target="_self">anpa1200.github.io/opencti-intelligent-shield</a>

<a href="https://1200km.com/opencti-intelligent-shield" target="_self">OpenCTI AI Enrichment | The Intelligent Shield</a>
...
#!/usr/bin/env python3
"""
Desert Hydra — Phase 3 OpenCTI graph import.Reads data/sources.yaml and data/procedures.yaml and creates:
...
**4. Hunt for PT43M now.**Query your Task Scheduler Operational logs for any task with a RepetitionInterval of PT43M. If you find one you didn't create, that is BugSleep. No other legitimate software uses this interval.
