...
- **Repository:** Not found as a dedicated local repo. No dedicated repository was found locally; commands and attack flow are preserved in the article body.
- **Preserved media:** 19 article image(s), including screenshots and infographics where present.
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*pYlSvXaZuWA0X8-qcTuWKg.png)
...
[This guide is a manual, step-by-step deployment of a GOAD-Mini Active Directory environment on…](../articles/2026/2026-01-24-active-directory-lab-for-pentest-manual-deployment-guide-cab28cd4ad8d.md)

[**Deploy a Complete Active Directory PenTest Lab in One Prompt with Cursor AI**
[How I automated the deployment of a complex AD lab environment using AI assistance](../articles/2026/2026-01-23-deploy-a-complete-active-directory-pentest-lab-in-one-prompt-with-cursor-ai-ff926fd2b3fc.md)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*ViDm2rAXqfwk-JQ1jb6XNA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*Ibp3xeZP4czrrroEc4jZ4g.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*X8KN1HUHLElLwDdyP_w0sA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*iASnWIfXL2AKVKQqFOK_fA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*mdOn25OpN8Su2XYq.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*lTvQltO0MnbM2UzU.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*1cOKo6-tK0PMi-2-.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*6cgGgYsn0d90hkIl.png)

### 2) Crack with hashcat (AS-REP roast)

[**Breaking the Code: How to Use Hashcat for Effective Password Cracking**
[Your step-by-step guide to mastering Hashcat, from setting it up on your system to deploying it against complex…](../articles/2024/2024-11-03-breaking-the-code-how-to-use-hashcat-for-effective-password-cracking-15f8da8facb8.md)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*D87Buy90Hup7z3Fn.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*EK_9iyuhhnIumCBYEzN-lw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*3AKXuxdsb7Z6_sNfPsxovQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*gtndtcHVA3gFXEvRe_kA6g.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*47VhYPpUGsWf0so1IJSFpQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*urkdv2aGaE2vqOFa9nEHjw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*5WpkUomEqYwT-_3RUzMMhQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*e4IrqWvQ3Z6qDcMy1NjeBQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*hEzDeMrbl1aqHlrJeVJ51g.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*9XigbXY1nCmTORhO0xZs5A.png)
