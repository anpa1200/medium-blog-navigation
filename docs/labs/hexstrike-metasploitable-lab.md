---
id: "hexstrike-metasploitable-lab"
title: "HexStrike+OpenAI Codex. AI-Driven Exploitation of Metasploitable."
description: "How I Used an LLM-Orchestrated Toolchain to Enumerate and Exploit a Deliberately Vulnerable Host (With Real Proofs)"
---
...
- **Source article:** [https://medium.com/@1200km/hexstrike-openai-codex-ai-driven-exploitation-of-metasploitable-b892c07be39f](https://medium.com/@1200km/hexstrike-openai-codex-ai-driven-exploitation-of-metasploitable-b892c07be39f)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*ryG5h9VfySviXapLEyOSvg.png)
...
[**HexStrike on Kali Linux 2025.4: A Comprehensive Guide**](../articles/2025/2025-12-18-hexstrike-ai-install-configure-and-run-mcp-with-gemini-openai-cursor-llama-85a0e5752949.md)

- *Focus: Initial setup and overview of the AI-powered offensive security framework.*

[**HexStrike-AI: A Force Multiplier for Red Teams — and a Dangerous Shift in the Threat Landscape**](../articles/2025/2025-12-25-hexstrike-ai-a-force-multiplier-for-red-teams-and-a-dangerous-shift-in-the-threat-landscap-3e1d4e86f3ae.md)

- *Focus: Analysis of AI-orchestrated pentesting and its implications.*

[**HexStrike MCP Orchestration with Ollama: Ubuntu Host, Kali VM, SSH Bridging, and Performance…**](../articles/2025/2025-12-31-hexstrike-mcp-orchestration-with-ollama-ubuntu-host-kali-vm-ssh-bridging-and-performance-f049ab140596.md)

- *Focus: Technical architecture using Model Context Protocol (MCP) and local LLMs.*

### Practical Applications & Lab Comparisons

[**HexStrike + Gemini vs. HackerAI: “Ops Copilot” vs. “Chatbot with Tools”**](../articles/2025/2025-12-26-hexstrike-gemini-vs-hackerai-ops-copilot-vs-chatbot-with-tools-1d799845410b.md)

- *Focus: Practical lab comparison of orchestration quality between different AI security tools.*

[**AI-Driven Pentesting at Home: Using HexStrike-AI for Full Network Discovery and Exploitation**](../articles/2025/2025-12-21-ai-driven-pentesting-at-home-using-hexstrike-ai-for-full-network-discovery-and-exploitatio-00a9e88b3bde.md)

- *Focus: Step-by-step home lab application for network enumeration.*

### Specific Tooling & Technique Guides

- [**AI-Driven Web Application Pentesting with HexStrike-AI**](../articles/2025/2025-12-22-ai-driven-web-application-pentesting-with-hexstrike-ai-67f3dae32040.md)

- [**Integrating Shodan with HexStrike-AI Using Gemini-CLI**](../articles/2025/2025-12-23-integrating-shodan-with-hexstrike-ai-using-gemini-cli-b6f9fcbe8e6e.md)

- [**AI-Driven Wireless Penetration Testing. One Prompt WIFI cracking**](../articles/2025/2025-12-24-ai-driven-wireless-penetration-testing-one-promt-wifi-cracking-6477c06f6af4.md)(Using HexStrike-AI)

- [**AI-Driven Office Documents Password Recovery with HexStrike-AI and Gemini-CLI**](../articles/2025/2025-12-29-ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli-3c8bb7deb82d.md)

- [**AI-Driven PDF Password Recovery with HexStrike-AI and Gemini-CLI**](../articles/2025/2025-12-29-ai-driven-pdf-password-recovery-with-hexstrike-ai-and-gemini-cli-cfa7eb0fae91.md)

- [**AI-Driven ZIP Password Recovery with HexStrike-AI and Gemini-CLI**](../articles/2025/2025-12-25-ai-driven-zip-password-recovery-with-hexstrike-ai-and-gemini-cli-b8fc5c475ebc.md)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*2tkO21QPoKIaAHV2GLTiXg.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*eABegFDYfVOV0X7OTkDnxA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*M-KtDpNJKOmzKguYuZsk3A.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*i537IaV4nzH-Yl0WAUFAbA.png)

## Phase 4: Exploitation (With Proofs)

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*Cwm_odt5ix6oogYUhn6w-Q.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*4DkOtawu-LswnG3baLupuA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*upLkdxiWzfTbKmUNw6A5rg.png)
