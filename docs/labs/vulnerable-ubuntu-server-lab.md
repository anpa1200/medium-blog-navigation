---
id: "vulnerable-ubuntu-server-lab"
...
- **Repository:** Not found as a dedicated local repo. No dedicated repository was found locally; the Ubuntu lab build steps are preserved in the article body.
- **Preserved media:** 4 article image(s), including screenshots and infographics where present.
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*BXEZxGFa7d08ft9ktYNq_A.png)
...
[HexStrike AI is an AI-powered offensive security framework that merges multi-agent AI with 150+ professional pentesting…](../articles/2025/2025-12-18-hexstrike-ai-install-configure-and-run-mcp-with-gemini-openai-cursor-llama-85a0e5752949.md)

[**Building an Extremely Vulnerable Windows 10 Lab: A Step-by-Step Guide (Bonus:Full PT with…**
[Hands-on guide to creating an intentionally insecure Windows 10 VM with open SSH, SMB, RDP, FTP, privilege escalation…](../articles/2026/2026-01-05-building-an-extremely-vulnerable-windows-10-lab-a-step-by-step-guide-bonus-full-pt-with-9290d388744c.md)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*-PPf5vehqf7QohBy1n4bBw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*GsxDbtudG9XFKLfgQ17lGQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*o9L68FSF08YQRs4gvRpGmg.png)
