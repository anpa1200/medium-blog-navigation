---
id: "operation-dragonrx-lab-architecture"
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*RbXPLislKRT4nLittXgygA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*FZYP29shwahtthg9pc07fw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*-kOI-vN2wgOLYaa1daoHYA.png)

**Prints a formatted access summary on completion with elapsed time.**

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*eGV5i2vDBJ8hzbSDXicFVQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*4kFH8ypI-dNmmWXOHlA-sg.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*FN-y_62tr7fOyTJ9CHVCuw.png)

## VM Specifications

Three Windows VMs managed by Vagrant and VirtualBox. All use WinRM for Ansible communication; no manual RDP setup required.

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*631vlsCkQu1VZ8iocSr6jA.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*_JUC6Q_phpWcpVLaO17_uQ.png)

**Minimum host requirements:**

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*O6mmjkGRqr7oQj_D-J3BIw.png)

**Access points once deployed:**

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*JYpbtZTNXUiwAfZjmknUDw.png)
