...
- **Repository:** [https://github.com/anpa1200/CTI/tree/main/Kubernetes](https://github.com/anpa1200/CTI/tree/main/Kubernetes)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*No6vYBwr0bvT5zmY0Fm5jg.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*Nt9xZM6zWqbBhVlfGHZtSQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*MwkUuvDTYcio1lug8_iOfQ.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*u6OClbaXmyOQUf-q0N_NbA.png)
...
`
        ...
        <body style="font-family: Arial; margin: 40px;">
            ...
            <h2>Endpoints:</h2>
            <ul>
                <li><a href="https://1200km.com/api/token" target="_self">GET /api/token</a> - Expose service account token</li>
                <li><a href="https://1200km.com/api/namespace" target="_self">GET /api/namespace</a> - Expose namespace</li>
                <li><a href="https://1200km.com/api/k8s/pods" target="_self">GET /api/k8s/pods</a> - Access K8S API (pods)</li>
                <li><a href="https://1200km.com/api/k8s/secrets" target="_self">GET /api/k8s/secrets</a> - Access K8S API (secrets)</li>
                <li><a href="https://1200km.com/api/logs" target="_self">GET /api/logs</a> - View logs with sensitive data</li>
            </ul>
        </body>
        </html>
    `
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*ik0E2VxRIZBHx6_ZDUdNdw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*sz1YoM0lR1WO9mvwhqJUdQ.png)
