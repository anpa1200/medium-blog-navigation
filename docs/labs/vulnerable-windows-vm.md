---
id: "vulnerable-windows-vm"
title: "How to Create a Vulnerable Windows Virtual Machine for Pentesting Training with scripts!"
description: "Building Your Cybersecurity Playground: Step-by-Step Guide to Creating a Vulnerable Windows VM for Ethical Hacking Practice"
---
...
- **Source article:** [https://medium.com/@1200km/how-to-create-a-vulnerable-windows-virtual-machine-for-pentesting-training-with-scripts-6dc39f0b3bb3](https://medium.com/@1200km/how-to-create-a-vulnerable-windows-virtual-machine-for-pentesting-training-with-scripts-6dc39f0b3bb3)
- **Published:** 2024-11-20
- **Repository:** Not found as a dedicated local repo. No dedicated repository was found locally; the deployment scripts are preserved in the article body.
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/0*xd1VcO6c5nvmo5dd)
...
- **Memory (RAM):**At least**8 GB**to allocate sufficient resources to both the VM and the host system.

- **Storage:**At least**50 GB of free disk space**to accommodate the VM and additional software installations.

- **Processor:**A modern multi-core CPU with**virtualization support (VT-x/AMD-V)**enabled in the BIOS.
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*pUOAZr8cNVCCw0m7KcGSVg.png)
...
3. Double-click**Turn off Microsoft Defender Antivirus**and select**Enabled**.

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*ynH-wjWavrbiVnpAmMn3sw.png)
...
![Article screenshot](https://cdn-images-1.medium.com/max/800/1*oiafzbpbUbhgl0oQgjgrUA.png)
...
3. Open**Windows Firewall: Protect all network connections**, and set it to**Disabled**.

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*AafjJ7rFYRsYRl0hx7U1ow.png)

4. Do the same for the**Domain Profile**and**Public Profile**.
...
- Navigate to**Control Panel &gt; User Accounts &gt; Change User Account Control settings**, and set the slider to**Never Notify**.

![Article screenshot](https://cdn-images-1.medium.com/max/800/1*UN0s9qhdWwcbg7XU6APhog.png)
