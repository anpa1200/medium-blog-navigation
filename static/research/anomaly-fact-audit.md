...
| A04 | P1 | Historical infographics can contradict corrected prose | All 44 media references retained; 43 non-cover figures moved into an explicitly superseded historical appendix, not used as current guidance. **§9.8** | historical_not_revalidated |
...
The original article URL, existing article routes/canonicals, all prior heading anchors, 15 anomaly tags and 30 incident mappings are preserved. The 44 original images remain available, with non-cover images in a clearly superseded historical appendix. They have not received a new visual fact audit. Do not cite them as validated current implementation guidance.
